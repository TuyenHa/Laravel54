		...
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-heading"><svg class="glyph stroked clipboard with paper"><use xlink:href="#stroked-clipboard-with-paper"/></svg>
					...
					<use xlink:href="#stroked-email"></use></svg>Thêm danh muc</div>
					<div class="panel-body">
					@include('errors.note')
						<form class="form-horizontal" action="{{route('postAddCate')}}" method="post">
							<fieldset>
								{{csrf_field()}}
								<!-- Name input-->
								<div class="form-group">
									...
									<div class="col-md-6">
										<input id="name" name="name" type="text" placeholder="Nhập tên danh mục" required="" class="form-control">
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-3 control-label" for="name">Link thân thiện</label>
									<div class="col-md-6">
										<input id="name" name="link" required="" type="text" placeholder="Nhập link thân thiện" class="form-control">
									</div>
								</div>
								<!-- Form actions -->
								<div class="form-group">
									<div class="col-md-9 widget-right">
										<button type="submit" class="btn btn-danger btn-md pull-right">Thêm danh mục</button>
									</div>
								</div>
							</fieldset>
						</form>
